...
public class BFSMaze : MonoBehaviour
{
    public int width = 21;
    ...
    public GameObject greenPathPrefab;
    public GameObject bluePlayerPrefab;
    public GameObject yellowFarthestPrefab;
    ...
    public void GenerateValidMap()
    {
        ...
        while (true)
        {
            ...
            if (validPath != null)
            {
                Debug.Log($"맵 생성 성공! ({attempt}회 시도)");
                break;
            }
        }
    ...
    void SpawnPlayer()
    {
        playerInstance = Instantiate(bluePlayerPrefab, new Vector3(startPos.x, 1f, startPos.y), Quaternion.identity);
    ...
    public void ShowPath()
    {
        ...
        {
            GameObject pathObj = Instantiate(greenPathPrefab, new Vector3(node.x, 0.1f, node.y), Quaternion.identity);
    ...
    {
        if (yellowFarthestPrefab == null) return;

        farthestInstance = Instantiate(yellowFarthestPrefab, new Vector3(farthestPos.x, 0.5f, farthestPos.y), Quaternion.identity);
    ...
    IEnumerator MoveRoutine()
    {
        ...
        {
            playerInstance.transform.position = new Vector3(targetPos.x, 1f, targetPos.y);
