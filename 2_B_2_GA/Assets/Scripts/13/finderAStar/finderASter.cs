...
public class finderASter : MonoBehaviour
{
    public List<Vector2Int> AStar(int[,] map, Vector2Int start, Vector2Int goal)
    {
        int h = map.GetLength(0); // y
        int w = map.GetLength(1); // x
    ...
    {
        return gCost[pos.y, pos.x] + H(pos, goal);
    }
